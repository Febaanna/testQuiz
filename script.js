...
const quizArray = [
  {
    ...
    options: ["Lion", "Tiger", "fox", "Girrafe"],
    correct: "Tiger",
  },
  {
    id: "1",
...

  {
    ...
    options: ["Jack fruit tree", "Mango tree", "Banyan tree", "Coconut tree"],
    correct: "Banyan tree",
  },
  {
    id: "1",
    question: " Name the biggest continent in the world?",
    options: ["Africa", "Europea", "Antarctica", "Asia"],
    correct: "Asia",
  },
  {
    id: "2",
    question: "Which is the highest dam of India?",
    options: ["Tehri Dam", "Mettur Dam", "Sardar Sarovar Dam", "Rihand Dam"],
    correct: "Tehri Dam",
  },
  ...
  
  {
    ...
    options: ["Benjamin", "Benjamin Franklin", "Leonardo da Vinci", "Vikings"],
    correct: "Benjamin Franklin",
  },
  {
    id: "1",
    question: " Which metal is the lightest metal in world?",
    options: ["Platinum", "Zinc", "Lithium", "Gold"],
    correct: "Lithium",
  },
  {
    id: "2",
    question: "Which is the largest state of India?",
    options: ["Goa", "Gujarat", "Odisha", "Rajasthan "],
    correct: "Rajasthan",
  },

  {
    ...
    options: ["Holli", "Onam", "Vishu", "Easter"],
    correct: "Holli",
  },
  {
    id: "1",
    question: " Name the smallest continent?",
    options: ["Asia", "Australia", "Pacific", "Arctic"],
    correct: "Australia",
  },
  {
    id: "2",
